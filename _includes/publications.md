...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="author">
             <strong><i style="color:#7b5aa6">Haokun Chen</i></strong>,
    ...
    <div class="links">
      <a href="https://github.com/HaokunChen245/FedBiP" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Code</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="links">
      <a href="https://github.com/HaokunChen245/FedPop" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Code</a>
      ...
      <strong><i style="color:#e61919">Oral Presentation</i></strong>
    </div>
  </div>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="author">
		...
		<strong><i style="color:#7b5aa6">Haokun Chen <sup>*</sup> </i></strong>,
		<a href="https://www.dbs.ifi.lmu.de/~krompass/" style="color: black;">Denis Krompass</a>, 
		<a href="https://www.dbs.ifi.lmu.de/~tresp/" style="color: black;">Volker Tresp</a>,
